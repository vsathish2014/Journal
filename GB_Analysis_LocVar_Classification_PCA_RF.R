...
for (i in 1: noSamples ){
  ...
  train_predictions_prob_ST1[[i]] <-  predict(rfModel_ST1[[i]], sample_data_ST1_Train_4[[i]] )
  ...
  train_predictions_prob_ST2[[i]] <-  predict(rfModel_ST2[[i]], sample_data_ST2_Train_4[[i]] )
...
## Write prediction prob and actual to csv
fileTrainPredAct <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","Train_Pred_Act", "_dbf_",dbf,"_locVar",locVar,    "_PCA_RF.csv")
filePredAct <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","Pred_Act", "_dbf_",dbf,"_locVar",locVar,"_PCA_RF.csv")
...
fileCM_ST1 <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","CM_","SigType_1","_dbf_",dbf,"_locVar",locVar,"_PCA_RF.csv")
fileCM_ST2 <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","CM_","SigType_2","_dbf_",dbf,"_locVar",locVar,"_PCA_RF.csv")
