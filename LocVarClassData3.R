...
for ( i in  1:length(data_F_ST1_split)){ 
  ...
  data_F_ST1_c[[i]] <- cbind(data_F_ST1_split[[i]],data_F_ST1_prev[[i]],data_F_ST1_next[[i]])
...
for ( i in  1:length(data_F_ST2_split)){ 
  ...
  data_F_ST2_c[[i]] <- cbind(data_F_ST2_split[[i]],data_F_ST2_prev[[i]],data_F_ST2_next[[i]])
...
for ( i in  1:length(data_N_ST1_split)){ 
  ...
  data_N_ST1_c[[i]] <- cbind(data_N_ST1_split[[i]],data_N_ST1_prev[[i]],data_N_ST1_next[[i]])
...
for ( i in  1:length(data_N_ST2_split)){ 
  ...
  data_N_ST2_c[[i]] <- cbind(data_N_ST2_split[[i]],data_N_ST2_prev[[i]],data_N_ST2_next[[i]])
