...
#for (j in NormalRobotList){
  ...
  #for ( lastDay in dayList){  
    ...
    for (i in 1: noSamples ){
      ...
      train_predictions_prob_ST1[[i]] <- predict(SVMmodel_ST1[[i]], sample_data_ST1_Train_4[[i]] ,type="prob",probability = TRUE)
      ...
      train_predictions_prob_ST2[[i]] <- predict(SVMmodel_ST2[[i]], sample_data_ST2_Train_4[[i]] ,type="prob",probability = TRUE)
    ...
    fileTrainPredAct <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","Train_Pred_Act", "_dbf_",dbf,"_locVar",locVar,    "_PCA_SVM.csv")
    filePredAct <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","Pred_Act", "_dbf_",dbf,"_locVar",locVar,"_PCA_SVM.csv")
    ...
    fileCM_ST1 <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","CM_","SigType_1","_dbf_",dbf,"_locVar",locVar,"_PCA_SVM.csv")
    fileCM_ST2 <- paste0("C:/IIITD/WIP/Analysis/Journal/TestResults_Final/","CM_","SigType_2","_dbf_",dbf,"_locVar",locVar,"_PCA_SVM.csv")
